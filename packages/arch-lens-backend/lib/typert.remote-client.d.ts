...
declare module '@deepseek-ai/dsh-typert-protocol' {
  ...
  interface TypertRemoteMap {
    ...
    'archLens/entityTree': () => Promise<RemoteResult<Array<{ id: string; name: string; desc: string; pkg?: string; children?: Array<{ id: string; name: string; desc: string; }>; }> | { error: string; }>>
