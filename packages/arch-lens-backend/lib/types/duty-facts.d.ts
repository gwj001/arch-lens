...
export declare function dutyForNode(id: string, node: {
    blurb: string;
    blurbZh?: string;
}, language: string, summaries?: Record<string, string> | null): string;
/**
 ...
 */
export declare function mergeDutyFacts(summaries: Record<string, string> | null, nodes: readonly DutyNodeFacts[], language: string, clientBlurbs?: Record<string, string>): Record<string, string>;
//# sourceMappingURL=duty-facts.d.ts.map