 ...
 * @returns mermaid flowchart source.
 */
export function overviewFigureFromGraph(graph, ids, blurbOf) {
    const idSet = new Set(ids);
    const lines = ['flowchart TD'];
    for (const node of graph.nodes) {
 ...
 * @returns mermaid flowchart source.
 */
export function coreFlowchartFromGraph(graph, ids) {
    const idSet = new Set(ids);
    const lines = ['flowchart TD'];
    const byGroup = new Map();
    for (const node of graph.nodes) {
 ...
 * @returns mermaid erDiagram source.
 */
export function coreErDiagramFromGraph(graph, ids) {
    const idSet = new Set(ids);
    const lines = ['erDiagram'];
    for (const node of graph.nodes) {
        if (!idSet.has(node.id))
