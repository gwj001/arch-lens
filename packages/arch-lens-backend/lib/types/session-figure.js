 ...
 * @returns the user-message text.
 */
export function buildDynamicFigurePrompt(kind, index, language, figId, target, mermaidSource, blurbs, existing, claims) {
 ...
 */
export function buildFigureRepairPrompt(figureId, figId, diagram, title, summary, error) {
