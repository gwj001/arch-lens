...
const slots = new WeakMap<AbortSignal, { startedAt: number; status: GenerationStatus }>()
...
function slotFor(signal: AbortSignal): { startedAt: number; status: GenerationStatus } {
