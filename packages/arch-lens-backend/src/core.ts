...
async function llmPick(ctx: Context, index: CodeIndexResult, language: string, signal?: AbortSignal): Promise<string[]> {
...
export async function coreGraph(
  ...
  // — consumed BEFORE the chain-own LLM pick, AFTER the cache.
