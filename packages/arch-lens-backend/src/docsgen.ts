 ...
 */
export function priorRevisionPreamble(language: string): string {
  if (language === 'English') {
...
export function seqInductionRules(index: CodeIndexResult, language: string, summary?: string): string {
