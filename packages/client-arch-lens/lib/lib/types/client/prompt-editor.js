...
export function PromptEditor(props) {
    ...
    return h('div', { className: css.editor }, h('div', { className: css.head }, h('span', { className: css.title }, '✏️ 提示词编辑（保存在工作区 .arch-lens-prompts.json）'), h('span', { className: css.spacer }), h('button', { className: css.btn, onClick: onClose }, '✕')), h('div', { className: css.field }, h('div', { className: css.label }, '💡 全貌预讲解提示词（可用 {root} / {core} 占位符）'), h('textarea', {
