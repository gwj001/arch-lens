...
export function CallGraphView(props) {
    ...
    const pairFirst = (from, to) => (from < to ? from : to);
    ...
    edges.forEach((edge, index) => {
        ...
        }), h('polygon', { key: `eh${index}`, points: `${endX - utx * 9 - uty * 5},${endY - uty * 9 + utx * 5} ${endX - utx * 9 + uty * 5},${endY - uty * 9 - utx * 5} ${endX},${endY}`, className: css.arrowHead, onContextMenu: edgeAsk }), h('text', {
