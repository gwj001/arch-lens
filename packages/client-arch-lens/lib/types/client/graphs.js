...
export function SequenceGraph(props) {
    const { result, onDynamicRequest } = props;
    ...
    actors.forEach((actor, index) => {
        ...
        }), h('text', { key: `ht${index}`, x, y: 26, fontSize: 11, fontWeight: 600, textAnchor: 'middle', fill: '#333' }, actor), h('line', { key: `l${index}`, x1: x, y1: 44, x2: x, y2: height - 8, className: css.actorLane }));
    });
