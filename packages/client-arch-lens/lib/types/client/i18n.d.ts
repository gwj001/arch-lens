...
declare const UI_COPY: {
    readonly zh: {
        ...
        readonly drawEmpty: "输入要画的图并点「🎨 画图」：LLM 依据推断查证数据画图并给概要；默认不保存，需要时点保存";
        readonly drawGenerating: "正在画图…（会话中实时绘制，完成后自动展示图和概要）";
        readonly drawFailed: "画图失败：{msg}";
        readonly drawDone: "图已生成（未保存，可点「保存图和概要」）";
        readonly drawSave: "💾 保存图和概要";
        readonly drawSaved: "已保存：{path}";
        readonly drawSavedNote: "已保存图和概要：{path}";
        readonly drawRestored: "已从上次保存恢复；重新画图并点「保存图和概要」可覆盖";
        readonly drawSaveFailed: "保存失败：{msg}";
        readonly tipDraw: "动态出图：输入文字描述要画的图，LLM 依据推断查证数据画图并给概要；默认不保存，点「保存图和概要」才落盘";
    ...
    readonly en: {
        ...
        readonly drawEmpty: "Type what to draw and click \"🎨 Draw\": the LLM draws a figure + summary from LLM-inferred, verified scan data; not saved unless you save it";
        ...
        readonly drawDone: "Figure generated (not saved — click \"💾 Save figure + summary\")";
        readonly drawSave: "💾 Save figure + summary";
        readonly drawSaved: "Saved: {path}";
        readonly drawSavedNote: "Saved figure + summary: {path}";
        readonly drawRestored: "Restored the last saved figure; draw again and save to overwrite";
        readonly drawSaveFailed: "Save failed: {msg}";
        readonly tipDraw: "Dynamic draw: type what figure you want; the LLM draws it from LLM-inferred, verified scan data with a summary; not saved by default — \"💾 Save figure + summary\" persists it";
