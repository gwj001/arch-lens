...
const UI_COPY = {
    zh: {
        ...
        drawBtn: '🎨 画图',
        drawWorking: '画图中…',
        drawEmpty: '输入要画的图并点「🎨 画图」：LLM 依据推断查证数据画图并给概要；默认不保存，需要时点保存',
        drawGenerating: '正在画图…（会话中实时绘制，完成后自动展示图和概要）',
        drawFailed: '画图失败：{msg}',
        drawDone: '图已生成（未保存，可点「保存图和概要」）',
        drawSave: '💾 保存图和概要',
        drawSaved: '已保存：{path}',
        drawSavedNote: '已保存图和概要：{path}',
        drawRestored: '已从上次保存恢复；重新画图并点「保存图和概要」可覆盖',
        drawSaveFailed: '保存失败：{msg}',
        tipDraw: '动态出图：输入文字描述要画的图，LLM 依据推断查证数据画图并给概要；默认不保存，点「保存图和概要」才落盘',
    ...
    en: {
        ...
        drawBtn: '🎨 Draw',
        drawWorking: 'Drawing…',
        drawEmpty: 'Type what to draw and click "🎨 Draw": the LLM draws a figure + summary from LLM-inferred, verified scan data; not saved unless you save it',
        drawGenerating: 'Drawing… (the session draws in real time; figure + summary appear when done)',
        drawFailed: 'Draw failed: {msg}',
        drawDone: 'Figure generated (not saved — click "💾 Save figure + summary")',
        drawSave: '💾 Save figure + summary',
        drawSaved: 'Saved: {path}',
        drawSavedNote: 'Saved figure + summary: {path}',
        drawRestored: 'Restored the last saved figure; draw again and save to overwrite',
        drawSaveFailed: 'Save failed: {msg}',
        tipDraw: 'Dynamic draw: type what figure you want; the LLM draws it from LLM-inferred, verified scan data with a summary; not saved by default — "💾 Save figure + summary" persists it',
