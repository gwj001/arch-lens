        ...
        overviewView === 'static'
          ? overviewFig.status === 'ready'
            ? h('div', null,
                ...
                h(MermaidView, { key: 'overview', source: overviewFig.source, onNodeContext: label => openFollowUp('overview', label) }),
              )
          ...
          : dynamicFig !== null && dynamicFig.kind === 'overview' && dynamicFig.status === 'ready' && dynamicFig.diagram !== undefined
            ? h('div', null,
                ...
                h(MermaidView, { key: 'overview-ai', source: dynamicFig.diagram, onNodeContext: label => openFollowUp('overview', label), onRenderError: () => invalidateDynamicFigure(dynamicFig.kind, dynamicFig.key) }),
              )
