...
const UI_COPY = {
  zh: {
    ...
    editorModeHintDefault: '使用默认模板：随角色语言自动切换（中文 / English 各一套），切换语言即切换模板。',
  ...
  en: {
    ...
    editorModeHintDefault: 'Use the default templates: they switch with the role language (中文 / English), so changing the language changes the templates.',
